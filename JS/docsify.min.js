...
u+=(r='<button class="sidebar-toggle"><div class="sidebar-toggle-button" style="display:none;"><span></span><span></span><span></span></div></button><aside class="sidebar">'+((n=t).name?'<h1 class="app-name"><a class="app-name-link" data-nosearch>'+(n.logo?"<img alt="+n.name+" src="+n.logo+">":n.name)+"</a></h1>":"")
