...
function(t){var e=t.config.loadSidebar;if(t.rendered){var n=se(t.router,".sidebar-nav",!0,!0);e&&n&&(n.parentNode.innerHTML+=window.__SUB_SIDEBAR__),
t._bindEventOnRendered(n),t.$resetEvents(),h(t,"doneEach"),h(t,"ready")}else t.$fetch(function(e){return h(t,"ready")})}(a),h(a,"mounted")},He.route={},(Ne=He)._renderTo=function(e,t,n){var r=v(e);r&&(r[n?"outerHTML":"innerHTML"]=t)},
Ne._renderSidebar=function(e){var t=this.config,n=t.maxLevel,r=t.subMaxLevel,i=t.loadSidebar;
this._renderTo(".sidebar-nav",this.compiler.sidebar(e,n));var a=se(this.router,".sidebar-nav",!0,!0);i&&a?a.parentNode.innerHTML+=this.compiler.subSidebar(r)||"":
this.compiler.subSidebar(),this._bindEventOnRendered(a)},Ne._bindEventOnRendered=function(e){var t,n=this.config,r=n.autoHeader,i=n.auto2top;if(function(e){var t=x(".cover.show");ge=t?t.offsetHeight:0;
var n=v(".sidebar"),r=[];null!=n&&(r=w(n,"li"));for(var i=0,a=r.length;i<a;i+=1){var o=r[i],s=o.querySelector("a");if(s){var l=s.getAttribute("href");if("/"!==l){var c=e.parse(l),u=c.query.id,p=c.path;u&&(l=me(p,u))}l&&(ue[decodeURIComponent(l)]=o)}}if(!m){var h=e.getCurrentPath();E("scroll",function(){return fe(h)}),C("scroll",function(){return fe(h)}),C(n,"mouseover",function(){pe=!0}),C(n,"mouseleave",function(){pe=!1})}}(this.router),r&&e){var a=v("#main"),o=a.children[0];if(o&&"H1"!==o.tagName){var s=_("h1");s.innerText=e.innerText,A(a,s)}}i&&(void 0===(t=i)&&(t=0),be.scrollTop=!0===t?0:Number(t))},Ne._renderNav=function(e){e&&this._renderTo("nav",this.compiler.compile(e)),this.config.loadNavbar&&se(this.router,"nav")},Ne._renderMain=function(r,i,a){var o=this;if(void 0===i&&(i={}),!r)return _e.call(this,r);h(this,"beforeEach",r,function(e){var t,n=function(){i.updatedAt&&(t=we(t,i.updatedAt,o.config.formatUpdated)),h(o,"afterEach",t,function(e){return _e.call(o,e)})};o.isHTML?(t=o.result=r,n(),a()):ke({compiler:o.compiler,raw:e},function(e){t=o.compiler.compile(e),n(),a()})})},Ne._renderCover=function(e,t){var n=v(".cover");if($(v("main"),t?"add":"remove","hidden"),e){$(n,"add","show");var r=this.coverIsHTML?e:this.compiler.cover(e),i=r.trim().match('<p><img.*?data-origin="(.*?)"[^a]+alt="(.*?)">([^<]*?)</p>$');if(i){if("color"===i[2])n.style.background=i[1]+(i[3]||"");else{var a=i[1];$(n,"add","has-mask"),X(i[1])||(a=K(this.router.getBasePath(),i[1])),n.style.backgroundImage="url("+a+")",n.style.backgroundSize="cover",n.style.backgroundPosition="center center"}r=r.replace(i[0],"")}this._renderTo(".cover-main",r),oe()}else $(n,"remove","show")},Ne._updateRender=function(){!function(e){var t=v(".app-name-link"),n=e.config.nameLink,r=e.route.path;if(t)if(c(e.config.nameLink))t.setAttribute("href",n);else if("object"==typeof n){var i=Object.keys(n).filter(function(e){return-1<r.indexOf(e)})[0];t.setAttribute("href",n[i])}}(this)},qe=function(e,t,n){return Me&&Me.abort&&Me.abort(),Me=F(e,!0,n)},(ze=He)._loadSideAndNav=function(e,t,n,r)
{var i=this;return function(){if(!n)return r();Oe(e,t,n,function(e){i._renderSidebar(e),r()},i,!0)}},ze._fetch=function(n){var r=this;void 0===n&&(n=p);var e=this.route,i=e.path,a=G(e.query,["id"]),t=this.config,o=t.loadNavbar,s=t.requestHeaders,
l=t.loadSidebar,c=this.router.getFile(i),u=qe(c+a,0,s);this.isHTML=/\.html$/g.test(c),u.then(function(e,t){return r._renderMain(e,t,r._loadSideAndNav(i,a,l,n))},function(e){r._fetchFallbackPage(c,a,n)||r._fetch404(c,a,n)}),o&&Oe(i,a,o,function(e){return r._renderNav(e)},this,!0)},ze._fetchCover=function(){var t=this,e=this.config,n=e.coverpage,r=e.requestHeaders,i=this.route.query,a=Q(this.route.path);if(n){var o=null,s=this.route.path;if("string"==typeof n)"/"===s&&(o=n);else if(Array.isArray(n))o=-1<n.indexOf(s)&&"_coverpage";else{var l=n[s];o=!0===l?"_coverpage":l}var c=Boolean(o)&&this.config.onlyCover;return o?(o=this.router.getFile(a+o),this.coverIsHTML=/\.html$/g.test(o),F(o+G(i,["id"]),!1,r).then(function(e){return t._renderCover(e,c)})):this._renderCover(null,c),c}},ze.$fetch=function(e){var t=this;void 0===e&&(e=p);var n=function(){h(t,"doneEach"),e()};this._fetchCover()?n():this._fetch(function(){t.$resetEvents(),n()})},ze._fetchFallbackPage=function(n,r,i){var a=this;void 0===i&&(i=p);var e=this.config,t=e.requestHeaders,o=e.fallbackLanguages,
s=e.loadSidebar;if(!o)return!1;var l=n.split("/")[1];if(-1===o.indexOf(l))return!1;var c=n.replace(new RegExp("^/"+l),"");return qe(c+r,0,t).then(function(e,t){return a._renderMain(e,t,a._loadSideAndNav(n,r,s,i))},function(){return a._fetch404(n,r,i)}),!0},ze._fetch404=function(e,t,n){var r=this;void 0===n&&(n=p);
var i=this.config,a=i.loadSidebar,o=i.requestHeaders,s=i.notFoundPage,l=this._loadSideAndNav(e,t,a,n);if(s){var c=function(t,e){var n,r,i=e.notFoundPage,a="_404"+(e.ext||".md");switch(typeof i){case"boolean":r=a;break;case"string":r=i;break;case"object":r=(n=Object.keys(i).sort(function(e,t){return t.length-e.length}).find(function(e){return t.match(new RegExp("^"+e))}))&&i[n]||a}return r}(e,this.config);return qe(this.router.getFile(c),0,o).then(function(e,t){return r._renderMain(e,t,l)},function(){return r._renderMain(null,{},l)}),!0}return this._renderMain(null,{},l),!1},He.$resetEvents=function(){ve(this.route.path,this.route.query.id),this.config.loadNavbar&&se(this.router,"nav")},window.Docsify={util:Fe,dom:e,get:F,slugify:U,version:"4.9.4"},window.DocsifyCompiler=ie,window.marked=M,window.Prism=a,function(e){var t=document.readyState;if("complete"===t||"interactive"===t)return setTimeout(e,0);document.addEventListener("DOMContentLoaded",e)}(function(e){return new je})}();
